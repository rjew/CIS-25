...
PointRussellJ::PointRussellJ(FractionRussellJ* fracPtr1, FractionRussellJ* fracPtr2) : 
    x(*fracPtr1), y(*fracPtr2) {
}
...
PointRussellJ PointRussellJ::operator+(const PointRussellJ& rOp) const {
    return PointRussellJ(((x + rOp.x) / 2), ((y + rOp.y) / 2));
}
